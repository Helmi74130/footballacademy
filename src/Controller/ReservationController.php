...
class ReservationController extends AbstractController
{
    ...
    public function addReserve(Request $request, EntityManagerInterface $entityManager, TimeRepository $timeRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $form->getData();
            // On Récupère la date et l'heure et on le formate en timeStamp
            ...
            // On additionne les 2 pour récupérer le temps de début et on ajoute le temps de jeux pour récupérer le temps de fin
